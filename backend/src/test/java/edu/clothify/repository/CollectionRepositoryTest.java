...
import edu.clothify.config.CollectionServiceException;
...
public class CollectionRepositoryTest {
    ...
    class CollectionRepositorySave{
        ...
        void  CollectionRepository_SaveCollection_ReturnObject(){
            //Given
    ...
    class CollectionRepositoryDelete{
        ...
        void  CollectionRepository_DeleteCollection_ReturnVoid() throws CollectionServiceException {
            //Given
            Collection collection = Collection.builder().id(null).name("Winter").build();
            //When
            Collection saved = collectionRepository.save(collection);
    ...
    class CollectionRepositoryView{
        ...
        void CollectionRepository_GetAllCollection_ReturnList(){
            //Given
            Collection collection = Collection.builder().id(null).name("Winter").build();
            ...
            //Then
            Assertions.assertEquals("Winter", collection1.getName());
        }
        @Test
        @Order(2)
        @DisplayName("Get Collection By Id Repository")
        void CollectionRepository_GetCollectionById_ReturnList(){
            //Given
            Collection collection = Collection.builder().id(null).name("winter").build();
        ...
        void CollectionRepository_GetByName_ReturnList(){
            //Given
            Collection collection = Collection.builder().id(null).name("winter").build();
